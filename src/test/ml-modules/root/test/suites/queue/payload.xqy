...
let $map-payload-serialized := <queue:payload kind="map" xmlns:queue="http://marklogic.com/community/queue">
...
let $object-payload-serialized := <queue:payload kind="object" xmlns:queue="http://marklogic.com/community/queue">
...
let $array-payload-serialized := <queue:payload kind="array" xmlns:queue="http://marklogic.com/community/queue">
...
let $element-payload-serialized := <queue:payload kind="element" xmlns:queue="http://marklogic.com/community/queue">
    <payload>
        <key>value</key>
        <item2></item2>
    </payload>
...
let $array-node-payload-serialized := <queue:payload kind="array" xmlns:queue="http://marklogic.com/community/queue">
    <json:array xmlns:json="http://marklogic.com/xdmp/json" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xs="http://www.w3.org/2001/XMLSchema">
...
let $object-node-payload-serialized := <queue:payload kind="object" xmlns:queue="http://marklogic.com/community/queue">
    <json:object xmlns:json="http://marklogic.com/xdmp/json" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xs="http://www.w3.org/2001/XMLSchema">
        <json:entry key="key1">
...
let $date-payload-serialized := <queue:payload kind="atomic" xmlns:queue="http://marklogic.com/community/queue">2020-11-19T09:34:23.832Z</queue:payload>

let $string-payload := 'string-value'
let $string-payload-serialized := <queue:payload kind="atomic" xmlns:queue="http://marklogic.com/community/queue">string-value</queue:payload>
